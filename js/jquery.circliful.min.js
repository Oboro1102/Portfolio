        ...
        return this.each(function () {
            ...
            function l() {
                var t = -1 !== navigator.userAgent.toLowerCase().indexOf("webkit") ? "body" : "html",
                    r = e(t).scrollTop(),
                    n = r + e(window).height(),
                    o = Math.round(P.offset().top),
                    l = o + P.height();
                return n > o && l > r
            }

            function a() {
                P.hasClass("start") || l(P) && (P.addClass("start"), setTimeout(t, 250))
            }
            ...
            var P = d.find(".circle"),
                ...
                Y = p,
                W = 3.6 * p;
            n.halfCircle && (W = 3.6 * p / 2), null !== n.replacePercentageByText && (Y = n.replacePercentageByText), n.start > 0 && n.target > 0 && (p = n.start / (n.target / 100), X = n.target / 100), 1 === n.animation ? n.animateInView ? e(window).scroll(function () {
                a()
            }) : t() : 1 !== n.multiPercentage ? (P.attr("stroke-dasharray", W + ", 20000"), 1 === n.showPercent ? b.find(".number").text(Y) : (b.find(".number").text(n.target), b.find(".percent").text(""))) : null !== n.replacePercentageByText && (b.find(".number").text(n.replacePercentageByText), b.find(".percent").text(""))
        })
    }
}(jQuery);
